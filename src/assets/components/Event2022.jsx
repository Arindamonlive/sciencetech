...
import model2k23 from "../images/ScienceTech2022.jpeg";
import { X } from "lucide-react"; // Close Icon

const images = [
  { src: model2k23, title: "Model Presentation 2022", desc: "An innovative showcase of student projects." },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg text-gray-700 text-center mb-8" data-aos="fade-up">
        ...
        2022. Students showcased their innovative projects, demonstrating creativity 
